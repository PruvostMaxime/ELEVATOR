    ...
    <?php  if ($result = $connexion->query("SELECT * FROM `eleves` ")) {
         while ($row = $result->fetch_assoc()) {
           ...
           <div class="form-group">
             ...
             <div class="col-md-8">
             <button id="edit_button" name="edit" class="btn btn-success"><a href="/sample/change_students.php?id=%s">Editer</button></a>

              <button id="del_button" name="del" class="btn btn-danger"><a href="/sample/delete_students.php?id=%s">Supprimer</button></a>
             </div>
           </div>
           ',
           $row["id"],

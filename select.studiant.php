...
<body>
  ...
  if ($result = $connexion->query("SELECT * FROM eleves")) {
    ...
    printf("</h1>");} ?>
      <?php while ($row = $result->fetch_array()) {
       ...
       printf("<thead>");
       printf("<tr>");
       printf("<td class = 'col-md-4'> Numero de l'eleve </td>");
       printf("<td class = 'col-md-4'> Prénom </td>");
       printf("<td class = 'col-md-4'> Nom </td>");
       printf("<td class = 'col-md-4'> Sexe</td>");
       printf("</tr>");
       printf("</thead>");
       printf("<tbody>");
